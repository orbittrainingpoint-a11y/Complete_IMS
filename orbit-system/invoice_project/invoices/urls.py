...
urlpatterns = [
    ...
    path('registrations/<int:pk>/send-cert-request/', views.send_cert_request, name='send_cert_request'),
    path('cert-request/<uuid:token>/', views.cert_request_form, name='cert_request_form'),
    path('cert-requests/', views.cert_requests_admin, name='cert_requests_admin'),
    path('cert-requests/<int:pk>/generate/', views.cert_request_generate, name='cert_request_generate'),
    path('cert-requests/<int:pk>/reject/', views.cert_request_reject, name='cert_request_reject'),
